...
class Game:
    ...
    def run(self):
        ...
        music = os.path.join(self.MUSIC, "scout.ogg")
    ...
    def draw(self, mpos, dt):
        ...
        self.rooms[self.cur_room][self.cur_view]['view'].draw(self.screen, dt, self.rooms)  
    ...
    def mouse_click(self, mpos):
        ...
        obj = self.rooms[self.cur_room][self.cur_view]['view'].click_check(mpos, self.rooms)
